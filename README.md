...
- No flash toggle or zoom support.
- No tap-to-focus or exposure controls.
- No in-app gallery preview.
- Limited to one image per capture (no burst mode or video).
...
- Enhanced UI with focus and exposure controls
- In-app gallery viewer
- Batch inference and image selection
