...
//            Log.d(
//                "OutputTensorShape",
//                "Extracted Shape: Batch=$batchSize, Channels=$channels, Height=$imageHeight, Width=$imageWidth"
//            )
//
//            // Calculate the total number of pixels
//            val outputSize = imageHeight * imageWidth * channels
...
//                    for (w in 0 until imageWidth) {
//                        // Convert to unsigned byte and store
//                        finalUByteArray[currentIndex++] =
//                            outputArray[0][(c * imageHeight * imageWidth) + (h * imageWidth) + w].toUByte()
//                    }
//                }
//            }
//
